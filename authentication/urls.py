...
from .views import RegisterView, EmailVerify, LoginAPIView, PasswordTokenCheckAPI,RequestPasswordRestEmail, SetNewPassword, LogutAPIView
...
urlpatterns = [
    ...
    path('logot/', LogutAPIView.as_view(), name="logout"),
